...
uniform float g_Length; // {"material":"ui_editor_properties_ray_length","default":0.5,"range":[0.01, 1]}
...
uniform vec3 g_Color2; // {"material":"ui_editor_properties_color_end","default":"1 1 1","type":"color"}

#if CASTER == 0
uniform vec2 g_Center; // {"material":"ui_editor_properties_center","default":"0.5 0.5"}
#else
